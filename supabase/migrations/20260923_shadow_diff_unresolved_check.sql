...
AS $function$
  ...
  union all
  select 'shadow_diff_unresolved', 'warning',
         count(*), 'Unresolved shadow-mode IBKR import diff older than 48h (flex_import_shadow_log) -- review before Phase 4 cutover'
